...
public class MailSummaryUtil {

    @Test
    public  void testQqEmail() throws AddressException,MessagingException {
        Properties properties = new Properties();
        properties.put("mail.transport.protocol", "smtp");// 连接协议
        properties.put("mail.smtp.host", "smtp.qq.com");// 主机名
        properties.put("mail.smtp.port", 465);// 端口号465
        ...
        // 设置发件人邮箱地址
        message.setFrom(new InternetAddress("353263668@qq.com"));
        // 设置收件人邮箱地址
        //message.setRecipients(Message.RecipientType.TO, new InternetAddress[]{new InternetAddress("1045174284@qq.com"),new InternetAddress("353263668@qq.com"),new InternetAddress("zhujianming@paymier.com")});
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("zhujianming@paymier.com"));//一个收件人
        // 设置邮件标题
        message.setSubject("姜老板你好我是zjm");
        // 设置邮件内容
        message.setText("姜老板你好，我是朱建明");
        // 得到邮差对象
        Transport transport = session.getTransport();
        // 连接自己的邮箱账户,密码为QQ邮箱开通的stmp服务后得到的客户端授权码
        //transport.connect("353263668@qq.com", "wisbgbfslkzobiab");//POP3/SMTP服务
        transport.connect("353263668@qq.com", "snkvocvkotvdbibi");//IMAP/SMTP服务:
        // 发送邮件
    ...
    public void test163Email(){
            ...
            try {
                ...
                contentPart.setText("姜老板你好，我是朱建明");
